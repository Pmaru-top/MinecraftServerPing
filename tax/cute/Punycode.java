...
/*
 * This code is not mine. It is from CSDN.
 * 
 * */
public class Punycode {
	...
	public static String encodeURL(String url) {
		...
		if(mainContent.contains(".")) mainContent = mainContent.substring(mainContent.lastIndexOf(".") + 1);
	 ...
	 * THIS IS NOT SUITABLE FOR UNICODE AND LETTER MIXING
	 *
